...
-------------------------------------------------------------------------------
-- Auto-install des binaires LSP manquants
-- Détecte brew > pacman > apt > dnf > zypper > winget, repli npm.
-- Déclencheur manuel : :LspInstallMissing

local lsp_pkg_map = {
  lua_ls   = { brew = "lua-language-server", pacman = "lua-language-server", apt = "lua-language-server", dnf = "lua-language-server", zypper = "lua-language-server", winget = nil, npm = nil },
  pyright  = { brew = "pyright", pacman = "pyright", apt = nil, dnf = nil, zypper = nil, winget = nil, npm = "pyright" },
  ts_ls    = { brew = "typescript-language-server", pacman = "typescript-language-server", apt = nil, dnf = nil, zypper = nil, winget = nil, npm = "typescript-language-server" },
  bashls   = { brew = "bash-language-server", pacman = "bash-language-server", apt = nil, dnf = nil, zypper = nil, winget = nil, npm = "bash-language-server" },
  jsonls   = { brew = "vscode-langservers-extracted", pacman = "vscode-json-languageserver", apt = nil, dnf = nil, zypper = nil, winget = nil, npm = "vscode-langservers-extracted" },
  marksman = { brew = "marksman", pacman = "marksman", apt = nil, dnf = nil, zypper = nil, winget = nil, npm = nil },
}

local function detect_pkg_manager()
  -- Ordre : brew (macOS/Linuxbrew) > pacman > apt > dnf > zypper > winget (Windows)
  for _, m in ipairs({ "brew", "pacman", "apt", "dnf", "zypper", "winget" }) do
...
local function install_cmd_for(manager, pkg)
  if manager == "brew"   then return { "brew", "install", pkg } end
  ...
  if manager == "winget" then return { "winget", "install", "-e", "--accept-source-agreements", "--accept-package-agreements", pkg } end
  return nil
end
...
end, { desc = "Installe les binaires LSP manquants (brew/pacman/apt/dnf/zypper/winget ou npm)" })
