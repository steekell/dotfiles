...
```powershell
irm https://raw.githubusercontent.com/steekell/dotfiles/v0.1.24/install.ps1 | iex
```
...
| `DOTFILES_REF` | `v0.1.24` | Branche ou tag git (override pour `main` en dev) |
...
- **macOS** dépendances hors brew (manuel, une fois) :
  1. Driver **Karabiner-DriverKit-VirtualHIDDevice v0.1.24** (pkg pqrs ; pas un brew package kanata)
