...
```sh
curl -fsSL https://raw.githubusercontent.com/steekell/dotfiles/v0.1.10/install.sh | sh
```
...
```powershell
irm https://raw.githubusercontent.com/steekell/dotfiles/v0.1.10/install.ps1 | iex
```
...
| `DOTFILES_REF` | `v0.1.10` | Branche ou tag git (override pour `main` en dev) |
